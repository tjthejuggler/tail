...
def setup_gui(num_bots):
    ...
    return root, outer_text_box, token_label_var
    ...
    for cycle in range(6):
        for bot_num, bot_memory in enumerate(character_memories):
            try:                
                ...
                outer_text_box.tag_add("white", position, outer_text_box.index(tk.END + "-1c"))
                outer_text_box.tag_config("white", foreground="white")
                ...
                if universe_response is not None:
                    ...
                    outer_text_box.tag_add(get_color_code("lime green"), position, outer_text_box.index(tk.END + "-1c"))
                    outer_text_box.tag_config(get_color_code("lime green"), foreground=get_color_code("lime green"))
